 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/Fxckgkd/goIndex-theme-Fxck@6.6/css/mdui_v2.min.css">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/Fxckgkd/goIndex-theme-Fxck@6.6/css/nexmoe_v2.min.css">');
document.write('<script src="//cdn.jsdelivr.net/gh/Fxckgkd/goIndex-theme-Fxck@6.6/js/mdui.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/Fxckgkd/goIndex-theme-Fxck@6.6/js/flv.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/Fxckgkd/goIndex-theme-Fxck@6.6/js/DPlayer.min.js"></script>');
document.write('<script src="https://cdnjs.loli.net/ajax/libs/blueimp-md5/2.10.0/js/md5.min.js"></script>');
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/Fxckgkd/goIndex-theme-Fxck@6.6/js/markdown-it.min.js"></script>');
